...
Vue is een framework dat geïnspireerd is op het MVVM patroon. Een Vue project bestaat over één root Vue instantie. Hierna verdeeld in een boom van herbruikbare components.Alle informatie over de basisprincipes in Vue komt uit de officiële Vue documentatie \autocite{_vue_2018}.
...
\subsection{Vergelijking criteria}
...
\subsubsection{Praktische vergelijking}
